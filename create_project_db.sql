...
-- create the employee table, make the foreign keys immediately as the two dependencies exist
...
-- now the manager relationship between department and employee is possible, alter the table and add the constraint
